...
@NgModule({
  declarations: [AddUserComponent, ActivateUserComponent, HelpComponent, LandingPageComponent,
    LoginComponent, ActivateDeviceComponent, AddDeviceComponent, ChangePinComponent, ResetPinComponent],
  imports: [
    SharedModule,
    FormsModule,
    ReactiveFormsModule
